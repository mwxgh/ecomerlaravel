...
<div class="content-wrapper">
  ...
  @include('element.content_header', ['object' => 'Role', 'action' => 'Add'])
  <!-- /.content-header -->
              ...
              <form action="{{ route('roles.store') }}" method="post" enctype="multipart/form-data">
                  ...
                  <div class="col-12">
                      <div class="form-group">
                        <label> Role</label>
                        <input type="text" class="form-control @error('name') is-invalid @enderror" name="name"  value="{{ old('name') }}" placeholder="Role">
                        @error('name')
                      ...
                      <div class="form-group">
                        ...
                        <textarea name="display_name" class="form-control @error('display_name') is-invalid @enderror" rows="5" placeholder="Description" >{{ old('display_name') }}</textarea>
                        @error('display_name')
                           <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                      </div>
                          ...
                          <div class="card border-primary mb-3 col-12">
                             ...
                             <div class="row">
                                 ...
                                 <div class="card-body text-primary col-md-3">
                                   <h5 class="card-title">
                                       <label>
                                           <input type="checkbox" name="permission_id[]" class="checkbox_children" value="{{$permissionsChildrenItem->id}}">
                                       </label>
